...
<div class="video-block section-padding">
   <div class="row">
      ...
      <div class="col-sm-10 text-right">
         <a href="{{url('e_testing/'.$depart->department_id)}}" class="btn btn-danger border-none"> กลับไปยังแบบฝึกหัดหลัก </a>
         <a href="{{url('start_test/'.$course_detail->Eid)}}" class="btn btn-success border-none">  ทำแบบฝึกหัดอีกครั้ง </a>
         <br /><br /><br />
      </div>
