...
<html lang="en">
   <head>
      ...
      <title>สมัครสามาชิก learnsbuy ระบบรายเดือน</title>
      <!-- Favicon Icon -->
                  ...
                  <div class="login-main-left">
                     <div class="text-center mb-5 login-main-left-header pt-4">
                       <a href="{{url('japanonline')}}">
                        ...
                        <h5 class="mt-3 mb-3">สมัครสามาชิก learnsbuy <!--{{Session::get('japanonline_redirect')}}--></h5>
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                       ...
                       <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="ชื่อ ของนักเรียน">
                       </div>
                        <div class="form-group">
                           <label>E-Mail Address</label>
                           <input type="text" class="form-control" placeholder="Enter E-Mail Address" name="email" value="{{ old('email') }}">
                        </div>
                        <div class="form-group">
                           <label>Password</label>
                           <input type="password" class="form-control" placeholder="Password 6 ตัว" name="password">
                        </div>
                        <div class="form-group">
                           <label>Confirm Password</label>
                           <input type="password" class="form-control" placeholder="Confirm Password 6 ตัว" name="password_confirmation">
                        </div>

                        <div class="mt-4">
                           <button type="submit" class="btn btn-outline-primary btn-block btn-lg">สมัครสมาชิก</button>
                        </div>
                     </form>
                     <div class="text-center mt-5">
                        <p class="light-gray">คุณมี Account อยู่แล้ว? <a href="{{url('/japanonline/login')}}">เข้าสู่ระบบ</a></p>
                     </div>
                  </div>
               </div>
               <div class="col-md-7">
