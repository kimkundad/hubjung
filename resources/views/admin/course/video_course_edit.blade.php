                ...
                <div class="tabs">
                  ...
                  <div class="tab-content">
                    <h4 class="mb-xlg">แก้ไขไฟล์ Video</h4>
    								...
    								<form id="newsForm121" class="form-horizontal" action="{{url('post_edit_video_course')}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
    										<label class="col-md-3 control-label" for="profileFirstName">รูปวีดีโอคอร์ส*</label>
    												<div class="col-md-8">
    														<img src="{{url('assets/uploads/'.$get_video->thumbnail_img)}}" class="img-responsive">
    											</div>
    									</div>
