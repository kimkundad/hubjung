                    ...
                    @endif
                      ...
                      {{ method_field($method) }}
                        ...
                        <div class="form-group">
													<label class="col-md-3 control-label" for="profileFirstName">หมวดหมู่ภาควิชา*</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="name_department" value="{{ $objs->name_department }}" >
														</div>
												</div>


												<div class="form-group">
                          <label class="col-md-3 control-label" for="exampleInputEmail1">รูปธงชาติ*</label>
                          <div class="col-md-8">
