...
<div>คุณสั่งซื้อคอร์ส {{$data->package_name}}</div>
<br>
...
<tr>
    ...
    <tr>
      ...
      <td style="text-align:right;font-size:12px">
        <span>THB{{$data->package_price}}</span>
        <span></span>
      </td>
    </tr>
</tbody>
...
<tr>
<td style="text-align:right;font-size:12px" width="150">
<span>ส่วนลด: </span>THB{{$data->discount}}.00
</td>
</tr>
<tr>
<td style="text-align:right;font-size:12px" width="150">
<span>รวม: </span>THB{{$data->package_price-$data->discount}}.00
</td>
</tr>
</tbody>
</table>
...
<img src="{{url('assets/image/logo/Learnsbuy_new_web_logo.png')}}" style="border:none; height:48px;" class="CToWUd">
</div>
</td>
