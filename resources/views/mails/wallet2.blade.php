...
<a href="#" target="_blank" ><img src="{{url('assets/image/logo/Learnsbuy_new_web_logo.png')}}" alt=""
...
<div style="margin:20px 0px;font-size:30px;line-height:30px;text-align:left">ทำรายการสั่งซื้อสำเร็จ</div>
<div style="margin-bottom:30px">
<div>คุณสั่งซื้อ {{$data->name_card}} สำเร็จแล้ว</div>
<br>
<div style="margin-bottom:20px;text-align:left">
  <b>หมายเลขคำสั่งซื้อ:</b> {{$data->Uid}}<br>
...
<tr>
    ...
    <tr>
      <td style="text-align:left;font-size:12px;padding-right:10px">
        <span>{{$data->name_card}}</span>
      </td>
      <td style="text-align:right;font-size:12px">
        <span>THB{{$data->money_card_sum}}.00</span>
        <span></span>
      </td>
    </tr>
</tbody>
...
<tr>
<td style="text-align:right;font-size:12px" width="150">
<span>รวม: </span>THB{{$data->money_card_sum}}.00
</td>
</tr>
</tbody>
</table>
      ...
      <td>
        <table style="margin-left:auto;font-size:12px">
          <tbody>
            ...
            <tr>
              <td style="font-size:12px;text-align:right">
                วันที่ {{$data->date_transfer}}, {{$data->time_transfer}}
              </td>
            </tr>
          </tbody>
        </table>
...
<img src="{{url('assets/image/logo/Learnsbuy_new_web_logo.png')}}" style="border:none; height:40px;" class="CToWUd">
</div>
</td>
